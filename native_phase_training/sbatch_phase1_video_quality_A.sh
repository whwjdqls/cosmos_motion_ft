...
#SBATCH --job-name=np1vqA
#SBATCH --output=/home/jungbin_cho/cosmos_motion_ft/slurm-np1vqA-%j.out
#SBATCH --exclusive
...
export NATIVEP1_RUN_NAME=native_phase1_vq_A_p1_global_lora_aw2_bs4_lr5e5_ema100k_qfilterv1_person
