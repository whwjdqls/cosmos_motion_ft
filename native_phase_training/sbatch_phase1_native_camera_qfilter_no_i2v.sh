...
#SBATCH --job-name=np1qf3
#SBATCH --output=/home/jungbin_cho/cosmos_motion_ft/slurm-np1qf3-%j.out
#SBATCH --exclusive
...
export NATIVEP1_RUN_NAME=native_phase1_camera_json_bs4_lora5e5_action4x_ema_100k_qfilterv1_noi2v
# Keep training queue behavior deterministic; evaluate selected checkpoints manually.
