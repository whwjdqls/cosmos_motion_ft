#!/bin/bash
# Ablation B: variable causal prefix with global generator Q/K/V/O LoRA.
#SBATCH -p a3ultra
#SBATCH --nodes=1
#SBATCH --gres=gpu:8
#SBATCH --ntasks=1
...
#SBATCH --job-name=np1vqB
#SBATCH --output=/home/jungbin_cho/cosmos_motion_ft/slurm-np1vqB-%j.out
#SBATCH --exclusive
...
export NATIVEP1_RUN_NAME=native_phase1_vq_B_varprefix_global_lora_aw2_bs4_lr5e5_ema100k_qfilterv1_person
