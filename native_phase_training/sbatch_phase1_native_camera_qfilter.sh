...
#SBATCH --job-name=np1qf4
#SBATCH --output=/home/jungbin_cho/cosmos_motion_ft/slurm-np1qf4-%j.out
#SBATCH --exclusive
...
export NATIVEP1_RUN_NAME=native_phase1_camera_json_bs4_lora5e5_action4x_ema_100k_qfilterv1
# Avoid creating 20 unsupervised one-GPU Slurm jobs while two-node jobs are pending.
