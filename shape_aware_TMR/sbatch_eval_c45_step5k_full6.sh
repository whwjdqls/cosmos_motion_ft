...
RUN=/mnt/shared/jungbin_cho/cosmos_motion_ft_runs/shape_tmr/c45_official30fps_balanced_10k

bash st_run.sh st_eval.py \
  --ckpt "${RUN}/step_00005000.pt" \
  --stats-path "${OFFICIAL}/stats/motion" \
  --out "${RUN}/full6_step_00005000.json"
