#!/usr/bin/env bash
#SBATCH --job-name=c37_offtxt_nojit
#SBATCH --partition=a2
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
bash st_run.sh st_train.py \
  --out-dir /mnt/shared/jungbin_cho/cosmos_motion_ft_runs/shape_tmr/c37_offtxt_frz_mu_rec001_klm1e5_nojitter \
