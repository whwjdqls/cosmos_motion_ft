...
#SBATCH --job-name=p3brnative
#SBATCH --output=/home/jungbin_cho/cosmos_motion_ft/slurm-p3brnative-%j.out
#SBATCH --exclusive
...
echo "[p3brnative] run=${RUN_NAME}"
echo "[p3brnative] Phase 1=${PHASE1} (EMA, LoRA rank16/alpha32, native Waver+shift3+UniPC)"
echo "[p3brnative] Phase 2=${PHASE2} (x0, native shifted logit-normal+Euler, T2M+TI2M)"
echo "[p3brnative] tasks=50% video2motion + 50% motimg2video; T=97; batch=4/GPU (global 32)"
echo "[p3brnative] frozen specialists; only 12 local directional modality bridges train"
